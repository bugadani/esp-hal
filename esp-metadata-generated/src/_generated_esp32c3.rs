...
macro_rules! for_each_gdma_channel {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_gdma_channel!((DMA_CH1, 1, DMA_CH1));
        _for_each_inner_gdma_channel!((DMA_CH2, 2, DMA_CH2));
        _for_each_inner_gdma_channel!((all(DMA_CH0, 0, DMA_CH0), (DMA_CH1, 1, DMA_CH1),
        (DMA_CH2, 2, DMA_CH2)));
    };
}
