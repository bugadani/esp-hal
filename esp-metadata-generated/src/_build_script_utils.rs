...
impl Chip {
        ...
        match self {
            Self::Esp32 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=flash_driver_supported",
                    ...
                    "cargo:rustc-cfg=context_switch_source=\"ipc\"",
            ...
            Self::Esp32c2 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=context_switch_source=\"from_cpu\"",
                    "cargo:rustc-cfg=mmu_page_size=\"65536\"",
            ...
            Self::Esp32c5 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=context_switch_source=\"clint\"",
                    "cargo:rustc-cfg=mmu_page_size=\"65536\"",
            ...
            Self::Esp32p4 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=soc_has_clint",
                    "cargo:rustc-cfg=soc_has_clint_other_core",
                    "cargo:rustc-cfg=soc_has_io_mux",
            ...
            Self::Esp32s2 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=interrupts_status_registers=\"3\"",
                    "cargo:rustc-cfg=interrupt_controller=\"xtensa\"",
                    "cargo:rustc-cfg=context_switch_source=\"software0\"",
                    "cargo:rustc-cfg=mmu_page_size=\"65536\"",
                    "cargo:rustc-cfg=mmu_entry_num=\"256\"",
            ...
            Self::Esp32s31 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=sdmmc_psram_dma",
                    "cargo:rustc-cfg=usb_otg_hs_fifo_depth_words=\"896\"",
                    "cargo:rustc-cfg=bt_controller=\"btdm2\"",
                    "cargo:rustc-cfg=wifi_has_wifi6",
                    "cargo:rustc-cfg=wifi_mac_version=\"3\"",
                    "cargo:rustc-cfg=wifi_csi_supported",
                    "cargo:rustc-cfg=ethernet_mii_via_gpio_matrix",
    ...
    pub fn all_possible_symbols() -> &'static [&'static str] {
        &[
            ...
            "bt_controller, values(\"btdm\",\"npl\",\"btdm2\")",
            ...
            "context_switch_source, values(\"ipc\",\"from_cpu\",\"clint\",\"software0\")",
