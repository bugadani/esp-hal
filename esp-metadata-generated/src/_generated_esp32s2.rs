...
macro_rules! for_each_pdma_channel {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        I2s0)],)); _for_each_inner_pdma_channel!((DMA_CRYPTO, Crypto,
        CryptoRegisterBlock, CRYPTO_DMA, [(AES, Aes), (SHA, Sha)],));
        _for_each_inner_pdma_channel!((all(DMA_SPI2, Spi, SpiRegisterBlock, SPI2_DMA,
        [(SPI2, Spi2)],), (DMA_SPI3, Spi, SpiRegisterBlock, SPI3_DMA, [(SPI3, Spi3)],),
        (DMA_I2S0, I2s, I2sRegisterBlock, I2S0, [(I2S0, I2s0)],), (DMA_CRYPTO, Crypto,
        CryptoRegisterBlock, CRYPTO_DMA, [(AES, Aes), (SHA, Sha)],)));
    };
}
