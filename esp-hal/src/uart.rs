...
where
    ...
    M: Mode,
{
    fn new(uart: impl Peripheral<P = impl Into<T> + Instance + 'd> + 'd) -> Self {
        crate::into_ref!(uart);
        Self {
            uart: uart.map_into(),
            phantom: PhantomData,
...
impl<'d> UartTx<'d, Blocking> {
    ...
    pub fn new<TX: PeripheralOutput>(
        uart: impl Peripheral<P = impl Into<AnyUart> + Instance + 'd> + 'd,
        tx: impl Peripheral<P = TX> + 'd,
    ) -> Result<Self, Error> {
        Self::new_typed(uart, tx)
    }
    ...
    pub fn new_with_config<TX: PeripheralOutput>(
        ...
        Self::new_with_config_typed(uart, config, tx)
    }
}
    ...
    T: Instance + 'd,
{
    ...
    pub fn new_typed<TX: PeripheralOutput>(
        uart: impl Peripheral<P = impl Into<T> + Instance + 'd> + 'd,
        tx: impl Peripheral<P = TX> + 'd,
    ) -> Result<Self, Error> {
...
impl<'d> UartRx<'d, Blocking> {
    ...
    pub fn new<RX: PeripheralInput>(
        ...
        UartRx::new_with_config(uart, Default::default(), rx)
    }
    ...
    pub fn new_with_config<RX: PeripheralInput>(
        ...
        UartRx::new_with_config_typed(uart, config, rx)
    }
}
    ...
    T: Instance + 'd,
{
    ...
    pub fn new_typed<RX: PeripheralInput>(
        ...
        Self::new_with_config_typed(uart, Default::default(), rx)
    }
...
impl<'d, T> crate::private::Sealed for Uart<'d, Blocking, T> where T: Instance + 'd {}

impl<'d, T> InterruptConfigurable for Uart<'d, Blocking, T>
where
    T: Instance + 'd,
{
...
pub trait Instance: crate::private::Sealed + Peripheral<P = Self> + PeripheralMarker {
...
macro_rules! impl_instance {
    ($inst:ident, $num:expr, $txd:ident, $rxd:ident, $cts:ident, $rts:ident, $peri:ident, $async_handler:path) => {
...
impl_instance!(UART0, 0, U0TXD, U0RXD, U0CTS, U0RTS, Uart0, asynch::uart0);
impl_instance!(UART1, 1, U1TXD, U1RXD, U1CTS, U1RTS, Uart1, asynch::uart1);
#[cfg(uart2)]
impl_instance!(UART2, 2, U2TXD, U2RXD, U2CTS, U2RTS, Uart2, asynch::uart2);
...
mod asynch {
    ...
    pub(crate) struct UartRxFuture<'d, T = AnyUart>
    where
        T: Instance,
    {
    ...
    #[must_use = "futures do nothing unless you `.await` or poll them"]
    pub(crate) struct UartTxFuture<'d, T = AnyUart>
    where
        T: Instance,
    {
    ...
    impl<'d> Uart<'d, Async> {
        ...
        pub fn new_async<RX: PeripheralInput, TX: PeripheralOutput>(
            ...
            Uart::new_async_with_config(uart, Default::default(), rx, tx)
        }
        ...
        pub fn new_async_with_config<RX: PeripheralInput, TX: PeripheralOutput>(
            ...
            Uart::new_async_with_config_typed(uart, config, rx, tx)
        }
    }
        ...
        T: Instance + 'd,
    {
        ...
        pub fn new_async_typed<RX: PeripheralInput, TX: PeripheralOutput>(
            ...
            Self::new_async_with_config_typed(uart, Default::default(), rx, tx)
        }
    ...
    impl<'d> UartTx<'d, Async> {
        ...
        pub fn new_async_with_config<TX: PeripheralOutput>(
            ...
            UartTx::new_async_with_config_typed(uart, config, tx)
        }
    }
        ...
        T: Instance + 'd,
    {
        ...
        pub fn new_async_typed<TX: PeripheralOutput>(
            ...
            UartTx::new_async_with_config_typed(uart, Default::default(), tx)
        }
    ...
    impl<'d> UartRx<'d, Async> {
        ...
        pub fn new_async_with_config<RX: PeripheralInput>(
            ...
            Self::new_async_with_config_typed(uart, config, rx)
        }
    }
        ...
        T: Instance + 'd,
    {
        ...
        pub fn new_async_typed<RX: PeripheralInput>(
            ...
            Self::new_async_with_config_typed(uart, Default::default(), rx)
        }
...
#[cfg(uart0)]
impl PeripheralMarker for crate::peripherals::UART0 {
    #[inline(always)]
    fn peripheral(&self) -> crate::system::Peripheral {
        crate::system::Peripheral::Uart0
    }
}

#[cfg(uart1)]
impl PeripheralMarker for crate::peripherals::UART1 {
    #[inline(always)]
    fn peripheral(&self) -> crate::system::Peripheral {
        crate::system::Peripheral::Uart1
    }
}

#[cfg(uart2)]
impl PeripheralMarker for crate::peripherals::UART2 {
    #[inline(always)]
    fn peripheral(&self) -> crate::system::Peripheral {
        crate::system::Peripheral::Uart2
    }
}

/// Any UART peripheral.
pub struct AnyUart(AnyUartInner);

impl crate::private::Sealed for AnyUart {}

#[cfg(uart0)]
impl From<crate::peripherals::UART0> for AnyUart {
    fn from(uart: crate::peripherals::UART0) -> Self {
        AnyUart(AnyUartInner::Uart0(uart))
    }
}

#[cfg(uart1)]
impl From<crate::peripherals::UART1> for AnyUart {
    fn from(uart: crate::peripherals::UART1) -> Self {
        AnyUart(AnyUartInner::Uart1(uart))
    }
}

#[cfg(uart2)]
impl From<crate::peripherals::UART2> for AnyUart {
    fn from(uart: crate::peripherals::UART2) -> Self {
        AnyUart(AnyUartInner::Uart2(uart))
    }
}
...
impl Peripheral for AnyUart {
    ...
    unsafe fn clone_unchecked(&self) -> Self::P {
        unsafe {
            match &self.0 {
                #[cfg(uart0)]
                AnyUartInner::Uart0(uart) => AnyUart::from(uart.clone_unchecked()),
                #[cfg(uart1)]
                AnyUartInner::Uart1(uart) => AnyUart::from(uart.clone_unchecked()),
                #[cfg(uart2)]
                AnyUartInner::Uart2(uart) => AnyUart::from(uart.clone_unchecked()),
            }
        }
    }
}

impl PeripheralMarker for AnyUart {
    #[inline(always)]
    fn peripheral(&self) -> crate::system::Peripheral {
        match &self.0 {
            #[cfg(uart0)]
            AnyUartInner::Uart0(uart) => uart.peripheral(),
            #[cfg(uart1)]
            AnyUartInner::Uart1(uart) => uart.peripheral(),
            #[cfg(uart2)]
            AnyUartInner::Uart2(uart) => uart.peripheral(),
        }
    }
}
