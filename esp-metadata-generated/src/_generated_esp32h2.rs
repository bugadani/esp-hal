...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        peri_type #[doc = "BT peripheral singleton"] BT <= virtual(LP_BLE_TIMER : {
        bind_lp_timer_interrupt, enable_lp_timer_interrupt, disable_lp_timer_interrupt },
        BT_MAC : { bind_mac_interrupt, enable_mac_interrupt, disable_mac_interrupt })
...
macro_rules! for_each_dma_channel {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        (), [DMA_IN_CH2, DMA_OUT_CH2], [],)); _for_each_inner_dma_channel!((all(DMA_CH0,
        0, Gdma, (), [DMA_IN_CH0, DMA_OUT_CH0], [],), (DMA_CH1, 1, Gdma, (), [DMA_IN_CH1,
        DMA_OUT_CH1], [],), (DMA_CH2, 2, Gdma, (), [DMA_IN_CH2, DMA_OUT_CH2], [],)));
    };
}
