...
macro_rules! for_each_dma_channel {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_dma_channel!((GDMA, DMA_CH1, 1, (DMA_CH1)));
        _for_each_inner_dma_channel!((GDMA, DMA_CH2, 2, (DMA_CH2)));
        _for_each_inner_dma_channel!((all(GDMA, DMA_CH0, 0, (DMA_CH0)), (GDMA, DMA_CH1,
        1, (DMA_CH1)), (GDMA, DMA_CH2, 2, (DMA_CH2))));
    };
}
