...
macro_rules! for_each_dma_channel {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        I2s0)],)); _for_each_inner_dma_channel!((DMA_CRYPTO, 0, Crypto,
        CryptoRegisterBlock, [CRYPTO_DMA], [(AES, Aes), (SHA, Sha)],));
        _for_each_inner_dma_channel!((all(DMA_SPI2, 0, Spi, SpiRegisterBlock, [SPI2_DMA],
        [(SPI2, Spi2)],), (DMA_SPI3, 0, Spi, SpiRegisterBlock, [SPI3_DMA], [(SPI3,
        Spi3)],), (DMA_I2S0, 0, I2s, I2sRegisterBlock, [I2S0], [(I2S0, I2s0)],),
        (DMA_CRYPTO, 0, Crypto, CryptoRegisterBlock, [CRYPTO_DMA], [(AES, Aes), (SHA,
        Sha)],)));
    };
}
