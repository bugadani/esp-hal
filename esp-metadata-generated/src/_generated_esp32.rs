...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        DMA_I2S1 <= I2S1(I2S1 : { bind_dma_interrupt, enable_dma_interrupt,
        disable_dma_interrupt }) (unstable))); _for_each_inner_peripheral!((@ peri_type
        ...
        _for_each_inner_peripheral!((SPI3, Spi3, 3)); _for_each_inner_peripheral!((all(@
        ...
        virtual() (unstable)), (@ peri_type #[doc = "DAC1 peripheral singleton"] DAC1 <=
        virtual() (unstable)), (@ peri_type #[doc = "DAC2 peripheral singleton"] DAC2 <=
        virtual() (unstable)), (@ peri_type #[doc = "FLASH peripheral singleton"] FLASH
        <= virtual() (unstable)), (@ peri_type #[doc = "PSRAM peripheral singleton"]
        PSRAM <= virtual() (unstable)), (@ peri_type #[doc =
        "SW_INTERRUPT peripheral singleton"] SW_INTERRUPT <= virtual() (unstable)), (@
        peri_type #[doc = "TOUCH peripheral singleton"] TOUCH <= virtual() (unstable))));
        ...
        (SYSTEM(unstable)), (EMAC_DMA(unstable)), (EMAC_EXT(unstable)),
        ...
        (UHCI1(unstable)), (WIFI), (DMA_SPI2(unstable)), (DMA_SPI3(unstable)),
        ...
        (I2S1, I2s1, 1), (SPI2, Spi2, 2), (SPI3, Spi3, 3)));
    };
}
#[macro_export]
#[cfg_attr(docsrs, doc(cfg(feature = "_device-selected")))]
macro_rules! for_each_dma_channel {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        => {} } _for_each_inner_dma_channel!((DMA_SPI2, 0, Spi, SpiRegisterBlock,
        [SPI2_DMA], [(SPI2, Spi2)],)); _for_each_inner_dma_channel!((DMA_SPI3, 0, Spi,
        SpiRegisterBlock, [SPI3_DMA], [(SPI3, Spi3)],));
        _for_each_inner_dma_channel!((DMA_I2S0, 0, I2s, I2sRegisterBlock, [I2S0], [(I2S0,
        I2s0)],)); _for_each_inner_dma_channel!((DMA_I2S1, 0, I2s, I2sRegisterBlock,
        [I2S1], [(I2S1, I2s1)],)); _for_each_inner_dma_channel!((all(DMA_SPI2, 0, Spi,
        SpiRegisterBlock, [SPI2_DMA], [(SPI2, Spi2)],), (DMA_SPI3, 0, Spi,
        SpiRegisterBlock, [SPI3_DMA], [(SPI3, Spi3)],), (DMA_I2S0, 0, I2s,
        I2sRegisterBlock, [I2S0], [(I2S0, I2s0)],), (DMA_I2S1, 0, I2s, I2sRegisterBlock,
        [I2S1], [(I2S1, I2s1)],)));
    };
}
